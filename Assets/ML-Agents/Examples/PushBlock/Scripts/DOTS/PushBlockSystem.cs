 ...
 //
 //                         NativeArray<RaycastInput> inputs = new NativeArray<RaycastInput>(rayInput.Angles.Length, Allocator.Temp);
 //                         for (int i = 0; i < rayInput.Angles.Length; i++)
 //                         {
 //                             var input = inputs[i];
 ...
 //                             filter.CollidesWith = c.DetectableTags.Value;
 //                             input.Filter = filter;
 //                             inputs[i] = input;
 //
